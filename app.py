...
def get_owned_games(steam_id):
    ...
    try:
        ...
        # Если сервер вернул ошибку (403, 500 и т.д.)
        if response.status_code != 200:
        ...
        # Если Steam не вернул список игр
...
def index():
    ...
    if request.method == "POST":
        ...
        # Если пользователь вставил полную ссылку на профиль,
        # оставляем только числовой Steam ID.
        ...
        try:
            ...
            # Если список игр не получен, скорее всего профиль закрыт.
            if games is None:
                error = (
